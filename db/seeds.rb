...
job1_applications.first.events.create([
  {type: "JobApplication::Event::Interview", data: {interviewed_at: 1.day.ago}},
  {type: "JobApplication::Event::Note", data: {content: "This candidate is great!"}},
  {type: "JobApplication::Event::Hired", data: {hired_at: 1.day.ago}}
])
# rejected
job1_applications.second.events.create([
  {type: "JobApplication::Event::Interview", data: {interviewed_at: 2.days.ago}},
  {type: "JobApplication::Event::Note", data: {content: "This candidate is not great."}},
